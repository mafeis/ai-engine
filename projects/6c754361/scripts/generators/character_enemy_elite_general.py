...
类型: character
风格: 像素风
描述: 体型巨大（普通兵两倍）。身披青铜重甲，手持巨大流星锤。头盔缝隙透出红色凶光。
"""
...
def generate():
    ...
    # 保存
    output_dir = os.path.dirname("./projects\6c754361\assets\characters\enemy_elite_general\enemy_elite_general.png")
    os.makedirs(output_dir, exist_ok=True)
    img.save("./projects\6c754361\assets\characters\enemy_elite_general\enemy_elite_general.png")
    print(f"✓ 已生成: ./projects\6c754361\assets\characters\enemy_elite_general\enemy_elite_general.png")
    return "./projects\6c754361\assets\characters\enemy_elite_general\enemy_elite_general.png"
