...
类型: character
风格: 像素风
描述: 矮黑身材，面容和善。穿着破损的紫色绸缎官服，手持泛黄《天书》。头顶有淡淡紫色云团特效。
"""
...
def generate():
    ...
    # 保存
    output_dir = os.path.dirname("./projects\6c754361\assets\characters\npc_song_jiang\npc_song_jiang.png")
    os.makedirs(output_dir, exist_ok=True)
    img.save("./projects\6c754361\assets\characters\npc_song_jiang\npc_song_jiang.png")
    print(f"✓ 已生成: ./projects\6c754361\assets\characters\npc_song_jiang\npc_song_jiang.png")
    return "./projects\6c754361\assets\characters\npc_song_jiang\npc_song_jiang.png"
