...
def generate():
    ...
    # 保存
    output_dir = os.path.dirname("./projects\6c754361\assets\characters\enemy_minion\enemy_minion.png")
    os.makedirs(output_dir, exist_ok=True)
    img.save("./projects\6c754361\assets\characters\enemy_minion\enemy_minion.png")
    print(f"✓ 已生成: ./projects\6c754361\assets\characters\enemy_minion\enemy_minion.png")
    return "./projects\6c754361\assets\characters\enemy_minion\enemy_minion.png"
